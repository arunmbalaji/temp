...
class EvalutorFactoryServiceLocator:
    """
    General evaluator factory that automatically loads datasets factories that are subclasses of EvaluatorFactoryBase
    """

    def __init__(self):
        # Expect the datset factory is under datasets path under the parent of the __file__
        datasets_base_dir = "evaluators"
        base_class = EvaluatorFactoryBase
